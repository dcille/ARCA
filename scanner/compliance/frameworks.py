    ...
    "CIS-M365-6.0.1": {
        ...
        "controls": [
            # ─── 1.x: Admin Center ───
            {
                "id": "1.1.1",
                "title": "Ensure Administrative accounts are cloud-only",
                "description": "Privileged admin accounts must be cloud-only (not synced from on-prem AD) and must not have app-based licenses assigned.",
                "checks": {"m365": ["m365_cis_admin_cloud_only"]},
            },
            {
                "id": "1.1.2",
                "title": "Ensure administrative accounts use MFA and phishing-resistant auth",
                "description": "Admin accounts must enforce MFA with phishing-resistant methods.",
                "checks": {"m365": ["m365_admin_mfa_enforced", "m365_user_mfa_registered", "m365_user_phishing_resistant_mfa"]},
            },
            {
                "id": "1.1.3",
                "title": "Ensure Security Defaults or Conditional Access policies are configured",
                "description": "Enable Security Defaults or equivalent Conditional Access policies for baseline protection.",
                "checks": {"m365": ["m365_security_defaults_enabled", "m365_ca_policies_configured"]},
            },
            {
                "id": "1.1.4",
                "title": "Ensure Conditional Access requires MFA with sign-in risk",
                "description": "Conditional Access policies must require MFA and evaluate sign-in risk.",
                "checks": {"m365": ["m365_ca_require_mfa", "m365_ca_sign_in_risk"]},
            },
            {
                "id": "1.1.5",
            ...
            },
            {
                ...
                "description": "Shared mailboxes must have direct sign-in blocked to prevent MFA bypass and unattributable actions.",
                "checks": {"m365": ["m365_cis_shared_mailbox_signin_blocked"]},
            },
            {
                "id": "1.2.2",
                "title": "Ensure privileged accounts are limited",
                "description": "Limit the number of users with admin privileges to reduce attack surface.",
                "checks": {"m365": ["m365_privileged_accounts_limited"]},
            },
            {
                "id": "1.2.3",
            ...
            {
                "id": "2.1.1",
                "title": "Ensure anti-phishing policies are configured with advanced settings",
                "description": "Anti-phishing policies must set phish threshold, enable impersonation protection, and honor DMARC.",
                "checks": {"m365": ["m365_cis_anti_phishing_advanced", "m365_anti_phishing_policy"]},
            },
            {
                "id": "2.1.2",
                "title": "Ensure Safe Attachments policy is enabled",
            ...
            {
                "id": "2.2.1",
                "title": "Ensure Microsoft Defender for Endpoint is enabled with low risk/exposure",
                "description": "Enable Defender for Endpoint for threat detection with proper risk and exposure management.",
                "checks": {"m365": ["m365_defender_sensor_active", "m365_defender_low_exposure", "m365_defender_low_risk"]},
            },
            {
                "id": "2.4.1",
                "title": "Ensure Microsoft Defender for Cloud Apps is connected",
                "description": "Defender for Cloud Apps must be connected for shadow IT discovery and anomalous behavior detection.",
                "checks": {"m365": ["m365_cis_defender_cloud_apps"]},
            },
            # ─── 3.x: Microsoft Purview ───
            {
            ...
            },
            {
                ...
                "checks": {"m365": ["m365_cis_dlp_policies_enabled", "m365_dlp_policies_configured"]},
            },
            {
                "id": "3.3.1",
                ...
                "checks": {"m365": ["m365_cis_sensitivity_labels_published", "m365_sensitivity_labels_enabled"]},
            },
            {
                "id": "3.3.2",
                "title": "Ensure Azure Information Protection encryption is enabled",
            ...
            {
                "id": "5.1.1",
                "title": "Ensure Conditional Access sign-in risk policy is configured",
                "description": "Configure sign-in risk evaluation in Conditional Access for adaptive authentication.",
                "checks": {"m365": ["m365_ca_sign_in_risk"]},
            },
            {
                "id": "5.3.1",
                "title": "Ensure PIM requires approval for Privileged Role Administrator",
            ...
            },
            {
                ...
                "title": "Ensure OneDrive sync is restricted to domain-joined computers",
                "description": "OneDrive sync must be restricted to domain-joined or managed devices.",
                "checks": {"m365": ["m365_cis_onedrive_sync_domain_joined", "m365_onedrive_sync_restricted"]},
            },
            # ─── 8.x: Teams ───
            {
                "id": "8.1.1",
            ...
            },
            {
                "id": "8.2.1",
                "title": "Ensure external access with trial tenants is blocked",
                "description": "ExternalAccessWithTrialTenants must be Blocked to prevent attacker social engineering.",
                "checks": {"m365": ["m365_cis_teams_trial_blocked"]},
            },
            {
                "id": "8.4.1",
